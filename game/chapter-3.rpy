define ch3_1 = Character("商人",what_prefix="\"",what_suffix="\"")
define ch3_2 = Character("糖果店老板",what_prefix="\"",what_suffix="\"")
...
#【加一段表示现在是下午俩人开始逛街的内心os】
    ...
    ch3_1 "啊，两位美丽的小姐，在下很荣幸向您们介绍。如您所见，这个精美的钟表出自南方的特拉科潘工匠之手，他们那精湛的铁系魔法技艺即使是密涅瓦女神看了也要赞叹不已……"
    ...
    ch3_1 "没错，这件完美的魔法工艺品完全值得称作是艺术品……这位小姐真是目光如炬，容我冒昧，您是魔法师吗?"
    ...
    ch3_1 "这位眼光敏锐的小姐，您可算是问对人了。要说这里谁最了解这个小玩意儿，那肯定是非我莫属。这家伙可不是个简单的钟表，里面的铁系魔法装置非常精妙，使它能够在不同的时间产生不同魔力流动形式……"
    ...
    ch3_1 "我向您保证，这家伙可是最精密的铁系魔法工艺品，不要说一年，就是十年，一百年，时间精密度也不会有哪怕1秒的差距……"

    ch3_1 "哦……我的天哪，我又说多了!您刚才问的是什么?哦，价钱的话，这件最精美的艺术品——我是说人类之手所能做出来的，只收您89枚银币——看在您也是位懂行的份上。"
    ...
    ch3_1 "哈哈哈，这位活泼的小姐，你可是说对了。这样一笔钱，即使放在那些最奢侈的贵族老爷手里，也够他们穷奢极欲一阵子了。但是，我敢和你打赌，这家伙绝对值这个价钱……"
    ...
    ch3_1 "当然没问题，交给您，我不能放心更多了。您是魔法——啊，我是说，这东西在您手里可比在我这种草帽手里妥帖得多了。只有识货的人，像您这样的，拿着它才有价值……"
    ...
    ch3_1 "啊哈，我想我们不需要这样做。那只是几枚硬币，也许我喝两天酒就花得一干二净了!"
...
## 两个人立绘出现（原位）
    ...
    ch3_1 "啊，原来是这位活泼的小姐。我猜你说的是特拉科潘吧，那可是一个真正的大城市。就如你所说，那里制作铁系魔法装置的工艺非常出名。"
    show noki 7:
        xpos 901
        ypos 80
    with dissolve
    ...
    ch3_1 "这位眼光敏锐的小姐，您说的确实不错。不过这都是以前的事啦，大概在几年前，战争结束之后，禁令就取消了。我去年在那里旅行的时候……"
    ...
    ch3_1 "喔，瞧瞧这位小姐发现了什么。这是在南方很常见的一种花，据说能让人心情平静。当地人经常用这种花做成饮料喝，它的名字就叫做……额，叫做……"
    ...
    ch3_1 "对对对，瞧瞧我这记性，是叫洛兰花。看来这位目光敏锐的小姐不仅目光敏锐啊，还是一位博学的学者呢。"
    ...
    ch3_1 "这位小姐真是博学啊……这里还有风干的洛兰花瓣在出售，两位小姐要不要买一些回去呢?"
    ...
    ch3_1 "两位小姐不用担心，我敢保证，这里绝对没有假冒产品，因为所有这些货物都是被我亲自带过来的。"
